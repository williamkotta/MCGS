...
{               ?>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Medicalcard<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="add-card.php">Add Card</a>
                            </li>
                            <li>
                                <a href="manage-card.php">Manage Card</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    ...
                    <li>
                        <a href="search-medicalcard.php"><i class="fa fa-search"></i>  Search</a>
                        
                        </li>
                        <li>
                        <a href="card-bwdates-report.php"><i class="fa fa-folder"></i>  Report of Medical Card</a>
